  ...
  function scheduleTopLevelUpdate(current, element, callback) {
    if (process.env.NODE_ENV !== 'production') {
      if (ReactDebugCurrentFiber.current !== null) {
        process.env.NODE_ENV !== 'production' ? warning(ReactDebugCurrentFiber.phase !== 'render', 'Render methods should be a pure function of props and state; ' + 'triggering nested component updates from render is not allowed. ' + 'If necessary, trigger nested updates in componentDidUpdate.\n\n' + 'Check the render method of %s.', getComponentName(ReactDebugCurrentFiber.current)) : void 0;
      }
    }
